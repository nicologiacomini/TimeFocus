...
import { Github, Timer, Clock } from 'lucide-react'
        ...
        <div className="grid grid-cols-2 gap-3">
          <Card className="bg-muted/50">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-xs text-muted-foreground">Track individual tasks</p>
            </CardContent>
          </Card>
          <Card className="bg-muted/50">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-xs text-muted-foreground">Monitor work sessions</p>
            </CardContent>
          </Card>
        </div>
